...
8. **Mark provisional** — fates are intentions; the real reconciliation against the suite (with a behavior baseline, by `specify-tests`) happens at execution.
